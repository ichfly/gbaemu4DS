...
void rtcSaveGame(gzFile file)
{
  utilGzWrite(file, &rtcClockData, sizeof(rtcClockData));
}

void rtcReadGame(gzFile file)
{
  utilGzRead(file, &rtcClockData, sizeof(rtcClockData));
}
