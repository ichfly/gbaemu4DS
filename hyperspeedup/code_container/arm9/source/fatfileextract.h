...
static inline u8 ichfly_readu8(unsigned int pos) //need lockup
{
...
static inline u16 ichfly_readu16(unsigned int pos) //need lockup
{
...
static inline u32 ichfly_readu32(unsigned int pos) //need lockup
{
