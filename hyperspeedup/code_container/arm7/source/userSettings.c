...
//---------------------------------------------------------------------------------
	...
	readFirmware( 0x20, (void *)&userSettingsBase,2);
	
	uint32 slot1Address = userSettingsBase * 8;
	uint32 slot2Address = userSettingsBase * 8 + 0x100;
	
	readFirmware( slot1Address , (void *)&slot1, sizeof(PERSONAL_DATA));
	readFirmware( slot2Address , (void *)&slot2, sizeof(PERSONAL_DATA));
	readFirmware( slot1Address + 0x70, (void *)&slot1count, 2);
	readFirmware( slot2Address + 0x70, (void *)&slot2count, 2);
	readFirmware( slot1Address + 0x72, (void *)&slot1CRC, 2);
	readFirmware( slot2Address + 0x72, (void *)&slot2CRC, 2);
